...
namespace AIRLINES {
	...
	/// </summary>
	public ref class Staff_Panel : public System::Windows::Forms::Form
	{
	public:
		Staff_Panel(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Staff_Panel::typeid));
			...
			this->panel1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Staff_Panel::panel1_Paint);
			// 
			// pictureBox1
			// 
			this->pictureBox1->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.BackgroundImage")));
			this->pictureBox1->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Stretch;
			this->pictureBox1->Location = System::Drawing::Point(75, 89);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(252, 184);
			...
			this->button1->Location = System::Drawing::Point(40, 533);
			...
			this->MyFlights->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(175)), static_cast<System::Int32>(static_cast<System::Byte>(135)),
				static_cast<System::Int32>(static_cast<System::Byte>(15)));
			this->MyFlights->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Stretch;
			...
			this->MyFlights->Location = System::Drawing::Point(40, 454);
			...
			this->MyFlights->Click += gcnew System::EventHandler(this, &Staff_Panel::MyFlights_Click);
			// 
			// ViewFlightsButton
			// 
			...
			this->ViewFlightsButton->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Stretch;
			this->ViewFlightsButton->Cursor = System::Windows::Forms::Cursors::Hand;
			...
			this->ViewFlightsButton->Location = System::Drawing::Point(40, 375);
			...
			this->ViewFlightsButton->Click += gcnew System::EventHandler(this, &Staff_Panel::ViewFlightsButton_Click);
			// 
			// panel2
			// 
			...
			this->panel2->Location = System::Drawing::Point(396, 0);
			this->panel2->Name = L"panel2";
			this->panel2->Size = System::Drawing::Size(789, 753);
			...
			this->dataGridView1->Location = System::Drawing::Point(44, 215);
			this->dataGridView1->Margin = System::Windows::Forms::Padding(4);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(696, 396);
			...
			this->label1->Location = System::Drawing::Point(208, 132);
			...
			this->Name = L"Staff_Panel";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Staff_Panel";
	...
	private: System::Void MyFlights_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try {
			...
			if (dataTable->Rows->Count == 0) {
				MessageBox::Show("No flights found for the current user.", "Information", MessageBoxButtons::OK, MessageBoxIcon::Information);
			}
		}
		catch (Exception^ ex) {
